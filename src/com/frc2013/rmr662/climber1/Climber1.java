 ...
 */
package com.frc2013.rmr662.climber1;
...
public class Climber1 extends Component {
...
// figure out what values stop the hook, and what values allow the hook to move	
	...
	public Climber1() {
		...
		sensors[0] = new RMRDigitalInput(SENSOR0, false);
		sensors[1] = new RMRDigitalInput(SENSOR1, false);
		sensors[2] = new RMRDigitalInput(SENSOR2, false);
		sensors[3] = new RMRDigitalInput(SENSOR3, false);
		sensors[4] = new RMRDigitalInput(SENSOR4, false);
		sensors[5] = new RMRDigitalInput(SENSOR5, false);
