...
public abstract class RobotMode extends Thread {
	...
	/**
	 * Called when the RobotMode begins running. Override this to do something here.
	 */
	...
	/**
	 * Called before the RobotMode finishes running. Override this to do something here.
	 */
